-- WealthOS — Supabase Schema Migration
...
-- (must exist before tables that reference it)
-- ============================================================
...
-- ============================================================
-- TABLES: all others (reference users + family_members)
-- ============================================================
...
-- users migrations
ALTER TABLE users ADD COLUMN IF NOT EXISTS replit_user_id TEXT UNIQUE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS full_name TEXT;
ALTER TABLE users ALTER COLUMN password_hash SET DEFAULT '';

-- portfolio_assets migrations
ALTER TABLE portfolio_assets ADD COLUMN IF NOT EXISTS category TEXT DEFAULT '';

-- goals migrations
ALTER TABLE goals ADD COLUMN IF NOT EXISTS is_active INTEGER DEFAULT 1;

-- fire_settings migrations
ALTER TABLE fire_settings ADD COLUMN IF NOT EXISTS corpus REAL;
ALTER TABLE fire_settings ADD COLUMN IF NOT EXISTS income REAL;
ALTER TABLE fire_settings ADD COLUMN IF NOT EXISTS expenses REAL;
ALTER TABLE fire_settings ADD COLUMN IF NOT EXISTS investments REAL;

-- family_members migrations
ALTER TABLE family_members ADD COLUMN IF NOT EXISTS retirement_age INTEGER DEFAULT 60;
...
CREATE INDEX IF NOT EXISTS idx_savings_plan_user_id ON savings_plan(user_id);

-- ============================================================
-- NEW COLUMNS (post-initial-schema additions)
-- ============================================================

-- New column: links Supabase Auth UUID to integer user ID
ALTER TABLE users ADD COLUMN IF NOT EXISTS supabase_auth_id TEXT UNIQUE;

-- New column added in recent code
ALTER TABLE family_members ADD COLUMN IF NOT EXISTS retirement_age INTEGER DEFAULT 60;
